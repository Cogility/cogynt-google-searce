...
terraform {
  backend "gcs" {
    ...
    prefix = "workload-identity/cogynt/cogynt-workstationpg-pooler" 
  }
}
...
module "workload_identities_cogynt_workstationpg_pooler" {
  source              = "terraform-google-modules/kubernetes-engine/google//modules/workload-identity" 
  project_id          = var.project_id
  name                = "cogynt"
  namespace           = "cogynt"
  use_existing_k8s_sa = true
  k8s_sa_name         = "cogynt-workstationpg-pooler"
...
output "workload_identities" {
  ...
  value       = module.workload_identities_cogynt_workstationpg_pooler
}
