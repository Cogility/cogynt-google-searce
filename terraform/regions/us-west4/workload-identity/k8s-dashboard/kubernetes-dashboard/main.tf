...
terraform {
  backend "gcs" {
    ...
    prefix = "workload-identity/k8s-dashboard/kubernetes-dashboard"
  }
}
...
module "workload_identities_dashboard" {
  source              = "terraform-google-modules/kubernetes-engine/google//modules/workload-identity" 
  project_id          = var.project_id
  name                = "k8s-dashboard"
  namespace           = "kubernetes-dashboard"
  use_existing_k8s_sa = true
  k8s_sa_name         = "kubernetes-dashboard"
...
output "workload_identities" {
  ...
  value       = module.workload_identities_dashboard
}
