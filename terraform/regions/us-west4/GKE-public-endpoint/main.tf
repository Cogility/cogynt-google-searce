...
terraform {
  backend "gcs" {
    ...
    prefix = "regions/us-west4/gke_cluster_public_endpoint"
  }
}
...
module "gke_private_cluster" {
  ...
  master_authorized_networks            = [
    {
      cidr_block   = "223.233.65.163/32" 
      display_name = "searce-engineer-ip"
    },
    {
      cidr_block   = "216.231.9.98/32" 
      display_name = "Cogility HQ"
    },
    {
      cidr_block   = "209.237.130.19/32" 
      display_name = "Acreto SJC"
    },
    {
      cidr_block   = "10.200.0.5/32"
      display_name = "cogility-mgnt-vm-ip"
    },
    {
      cidr_block   = "34.125.255.128/32"
      display_name = "nat-ip"
    }
  ]
